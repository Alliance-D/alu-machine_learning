...
def poly_derivative(poly):
    ...
    Returns:
        list: list of coefficients of the derivative, or [0] if derivative is zero,
    ...
    if len(poly) < 2:
        return [0]  # constant term only

    # Compute derivative: skip constant term and multiply each coefficient by its index
